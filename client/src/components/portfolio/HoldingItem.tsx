...
export default function HoldingItem({ holding }: Props) {
  ...
  return (
    <>
      <div
        onClick={handleClick}
        style={{ padding: '10px 16px', cursor: 'pointer', borderBottom: '1px solid #1e293b' }}
      ...
      >
        ...
        <button
          ...
          style={{ marginTop: '6px', width: '100%', padding: '4px', borderRadius: '6px', border: '1px solid #334155', background: 'transparent', color: '#94a3b8', cursor: 'pointer', fontSize: '11px' }}
        >
          매도
        </button>
      </div>
