      ...
      <div style={{ ...cardStyle, marginBottom: '16px' }}>
        ...
        {mode === 'dca' && (
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(4, 1fr)', gap: '12px' }}>
            ...
            <div>
              ...
              <input type="date" value={dcaEnd} max={toDateStr(new Date())} onChange={(e) => { const today = toDateStr(new Date()); setDcaEnd(e.target.value > today ? today : e.target.value); }} style={inputStyle} />
            </div>
            <div>
        ...
        {mode === 'buyhold' && (
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr 1fr' : 'repeat(3, 1fr)', gap: '12px' }}>
            ...
            <div>
              <label style={labelStyle}>종료일</label>
              <input type="date" value={bhEndDate} max={toDateStr(new Date())} onChange={(e) => { const today = toDateStr(new Date()); setBhEndDate(e.target.value > today ? today : e.target.value); }} style={inputStyle} />
            </div>
            <div>
