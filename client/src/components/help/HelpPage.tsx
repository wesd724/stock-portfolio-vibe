...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '종목 기본 정보', desc: '종목을 추가하면 차트 아래에 기본 정보 테이블이 표시됩니다. ETF는 유형·카테고리·운용사·구조·설정일·순자산(AUM)·총보수(Expense Ratio)·발행주식수·평균거래량을, 주식은 섹터·업종·웹사이트를 확인할 수 있습니다. 1종목만 추가해도 바로 볼 수 있으며, 데이터가 없는 항목은 자동으로 숨겨집니다.' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '결과 요약', desc: '총 투자금액·최종 평가금액·수익금·수익률을 카드 형태로 표시합니다. 수익이면 빨간색, 손실이면 파란색으로 구분됩니다. 적립식의 경우 실제 집행된 총 투자 횟수와 총 투자 기간(년·개월·일)도 함께 표시됩니다.' },
